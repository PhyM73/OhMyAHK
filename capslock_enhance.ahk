...
; - Send the Esc key if the CapsLock key is pressed alone.
; - Change the CapsLock status if CapsLock+Esc are pressed.  
; - Act as the Left Control key if the CapsLock is pressed with another key.
; - Enable Window Dragging by pressing CapsLock or the middle mouse button while use the mouse.
...
; Easy Window Dragging  https://www.autohotkey.com
